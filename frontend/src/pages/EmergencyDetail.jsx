...
export default function EmergencyDetail() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 pt-10 sm:pt-24 pb-24">
      <div className="max-w-6xl mx-auto px-4">
        {/* Back button */}
        <button
          onClick={() => navigate("/emergency")}
          className="flex items-center gap-2 text-sm cursor-pointer sm:text-lg font-semibold text-gray-600 hover:text-black mb-4 hover:font-bold"
        >
